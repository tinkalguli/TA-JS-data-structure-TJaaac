...
for (let userId of userIds) {
  if (userId % 2 === 0) evenUserIds.push(userId);
}

evenCollection.push(...evenNumbers, ...evenUserIds);
...
for (let userId of userIds) {
  if (userId % 2 !== 0)oddUserIds.push(userId);
}

oddCollection.push(...oddNumbers, ...oddUserIds);
