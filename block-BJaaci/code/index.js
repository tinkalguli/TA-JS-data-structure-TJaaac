...
movies[0].year > "2017" ? console.log(true) : console.log(false);
...
movies[0].title === `Hannah` ? console.log(`The title of the first movie is Hannah`)
                             : console.log(`The title of the first movie is not Hannah`);
...
if(movies[0].genres.length > 1) console.log(movies[0].title);
if(movies[1].genres.length > 1) console.log(movies[1].title);
if(movies[2].genres.length > 1) console.log(movies[2].title);
// 28. Log the name of all the movies with more than 1 actors
if(movies[0].actors.length > 1) console.log(movies[0].title);
if(movies[1].actors.length > 1) console.log(movies[1].title);
if(movies[2].actors.length > 1) console.log(movies[2].title);
// 29. Log the name of all the movies with exactly 3 actors
if(movies[0].actors.length === 3) console.log(movies[0].title);
if(movies[1].actors.length === 3) console.log(movies[1].title);
if(movies[2].actors.length === 3) console.log(movies[2].title);
// 30. Log the name of all the movies with year `2018`
if(movies[0].year === '2018') console.log(movies[0].title);
if(movies[1].year === '2018') console.log(movies[1].title);
if(movies[2].year === '2018') console.log(movies[2].title);